...
function sendemail_verify($userFirstName,$userEmail,$verify_token){
     ...
     <hr>
     <a href='http://localhost/carpool/verify-email.php?token=$verify_token'<button type='button' id='veributton' class='btn btn-info rounded-pill'>Verify Now!</button></a>
     <script src='https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js' integrity='sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4' crossorigin='anonymous'></script>
     <hr>
     <h4>Thank you and Let's RIDE!</h4>";
 
     //SETTING Email
     $mail->setFrom('email@buenaroa.store', 'Carpool App'); //Senders Email
